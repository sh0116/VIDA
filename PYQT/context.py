...
from FloorPlan import FloorPlan_standard
...
class Context:
	...
	def __init__(self, signals):
		...
		self.current_taglist = list()

		self.titlename = ""
		self.taglist = list()
		self.braille_transfer_taglist = list()
		self.custom_X,self.custom_Y = -1,-1
		self.custom_selection_X1,self.custom_selection_Y1,self.custom_selection_X2,self.custom_selection_Y2 = -1,-1,-1,-1
	...
	def loadImage(self, fileName):
		FloorPlan_standard.standard(fileName)
		#fileName[0] = "standard.jpg"
	...
	def loadDefaultsColor(self):
		...
		self.primaryColor = QtGui.QColor(self.getIntDefault("color", "primary_color", QtCore.Qt.color0))
		self.secondaryColor = QtGui.QColor(self.getIntDefault("color", "secondary_color", QtCore.Qt.color1))
